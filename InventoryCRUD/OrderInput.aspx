<%@ Page Title="" Language="C#" MasterPageFile="~/EmployeeSite.Master" AutoEventWireup="true" CodeBehind="OrderInput.aspx.cs" Inherits="SmartStore.OrderInput" %>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:InvConnectionString %>" SelectCommand="SELECT DISTINCT [prodName] FROM [Inventory]"></asp:SqlDataSource>
            </td>
        </tr>
        <tr>
            <td>Quantity:</td>
